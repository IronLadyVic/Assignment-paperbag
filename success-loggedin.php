...
echo '<div id="left-container-login">
	<div>
		...
		<p class="success-statements">thank you for logging in to paperbag boutique.<br/>please view your account details or start selling your second hand</br>labels by listing an item.</p>
